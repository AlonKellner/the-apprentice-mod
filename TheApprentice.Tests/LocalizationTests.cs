...
public class LocalizationTests
{
    ...
    public void CardsJson_HasAllPlannedCardKeys()
    {
        ...
        string[] expectedKeys = [
            ...
            "THEAPPRENTICE-METHOD_TO_THE_MADNESS.title", "THEAPPRENTICE-METHOD_TO_THE_MADNESS.description", "THEAPPRENTICE-METHOD_TO_THE_MADNESS+.description", "THEAPPRENTICE-METHOD_TO_THE_MADNESS.selectionPrompt",
