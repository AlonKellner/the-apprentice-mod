...
public class Crash : UnderstudyCard
{
    public const string CardId = "TheUnderstudy:Crash";

    public Crash() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
        WithDamage(7);
