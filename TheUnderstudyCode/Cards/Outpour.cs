...
public class Outpour : UnderstudyCard
{
    public const string CardId = "TheUnderstudy:Outpour";

    public Outpour() : base(1, CardType.Skill, CardRarity.Common, TargetType.None)
    {
