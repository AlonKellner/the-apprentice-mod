...
public class AllEyesOnMe : UnderstudyCard
{
    public const string CardId = "TheUnderstudy:AllEyesOnMe";

    public AllEyesOnMe() : base(1, CardType.Attack, CardRarity.Common, TargetType.AllEnemies)
    {
        WithDamage(6);
