...
public class Subversion : UnderstudyCard
{
    public const string CardId = "TheUnderstudy:Subversion";

    public Subversion() : base(1, CardType.Skill, CardRarity.Common, TargetType.None)
    {
    ...
    protected override async Task OnPlay(PlayerChoiceContext context, CardPlay cardPlay)
    {
        ...
        var selected = await CardSelectCmd.FromCombatPile(
            ...
            player,
            new CardSelectorPrefs(new LocString("cards", "THEUNDERSTUDY-SUBVERSION.selectionPrompt"), 0, 1),
