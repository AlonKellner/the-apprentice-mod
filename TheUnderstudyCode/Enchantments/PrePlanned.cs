...
// Persistent marker applied out of combat by the Drafting Paper relic: a deck card carrying it starts each
...
// enchantment fits per card, so a card can be Drafted or Foldable-Staged, not both (base CanEnchant
