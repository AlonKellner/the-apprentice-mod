...
public class Ristretto : ApprenticeCardB
{
    public const string CardId = "TheApprentice:Ristretto";
    ...
    protected override async Task OnPlay(PlayerChoiceContext context, CardPlay cardPlay)
    {
        ...
        var selected = await CardSelectCmd.FromHand(
            context, player,
            new CardSelectorPrefs(new LocString("cards", "THEAPPRENTICE-RISTRETTO.selectionPrompt"), 0, count),
