...
public class PlannedModifier : CardModifier
{
    ...
    // Planned tracking this combat" is needed (see ApprenticeCard.ApplyCombatStartModifiers for
    // the matching fix on the attach side).
    ...
    public static bool CanApplyTo(CardModel card) =>
        ...
        && !card.Keywords.Contains(ApprenticeKeywords.Stable);
