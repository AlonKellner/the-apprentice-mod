...
public class NewDeckCardsTests
{
    ...
    [InlineData(typeof(BareItAll), "TheUnderstudy:BareItAll", CardType.Skill, CardRarity.Uncommon, TargetType.AnyEnemy)]
    ...
    [InlineData(typeof(NervousEnergy), "TheUnderstudy:NervousEnergy", CardType.Skill, CardRarity.Rare, TargetType.None)]
    ...
    [InlineData(typeof(Bravado), "TheUnderstudy:Bravado", CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)]
    [InlineData(typeof(StandingOvation), "TheUnderstudy:StandingOvation", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
