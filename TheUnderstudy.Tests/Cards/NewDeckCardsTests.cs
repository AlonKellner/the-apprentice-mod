...
public class NewDeckCardsTests
{
    ...
    [InlineData(typeof(KeepInMind), "TheUnderstudy:KeepInMind", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
    ...
    [InlineData(typeof(Callback), "TheUnderstudy:Callback", CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)]
    ...
    [InlineData(typeof(Pumped), "TheUnderstudy:Pumped", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
    ...
    [InlineData(typeof(BackOfMyHand), "TheUnderstudy:BackOfMyHand", CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)]
    ...
    [InlineData(typeof(MaskDrop), "TheUnderstudy:MaskDrop", CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)]
    ...
    [InlineData(typeof(Improvise), "TheUnderstudy:Improvise", CardType.Skill, CardRarity.Rare, TargetType.None)]
    [InlineData(typeof(Canonical), "TheUnderstudy:Canonical", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
    ...
    [InlineData(typeof(OneTake), "TheUnderstudy:OneTake", CardType.Power, CardRarity.Ancient, TargetType.None)]
    [InlineData(typeof(StandingOvation), "TheUnderstudy:StandingOvation", CardType.Attack, CardRarity.Ancient, TargetType.AnyEnemy)]
    [InlineData(typeof(BrightSide), "TheUnderstudy:BrightSide", CardType.Power, CardRarity.Uncommon, TargetType.None)]
    [InlineData(typeof(Stereo), "TheUnderstudy:Stereo", CardType.Power, CardRarity.Rare, TargetType.None)]
    [InlineData(typeof(Intermission), "TheUnderstudy:Intermission", CardType.Power, CardRarity.Rare, TargetType.None)]
    ...
    [InlineData(typeof(Reverb), "TheUnderstudy:Reverb", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
    [InlineData(typeof(Duet), "TheUnderstudy:Duet", CardType.Skill, CardRarity.Uncommon, TargetType.AnyAlly)]
    [InlineData(typeof(PassTheMic), "TheUnderstudy:PassTheMic", CardType.Skill, CardRarity.Uncommon, TargetType.AnyAlly)]
    ...
    [Fact]
    public void CleanSlate_BaseHasExhaust() =>
        Assert.True(new CleanSlate().Keywords.Contains(CardKeyword.Exhaust));
