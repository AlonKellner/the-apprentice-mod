...
public class NewDeckCardsTests
{
    ...
    [InlineData(typeof(WriteItDown), "TheUnderstudy:WriteItDown", CardType.Skill, CardRarity.Uncommon, TargetType.None)]
    ...
    [InlineData(typeof(BodyDouble), "TheUnderstudy:BodyDouble", CardType.Skill, CardRarity.Common, TargetType.None)]
