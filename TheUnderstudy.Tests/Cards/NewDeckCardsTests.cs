...
public class NewDeckCardsTests
{
    ...
    [InlineData(typeof(WindUp), "TheUnderstudy:WindUp", CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)]
    ...
    [InlineData(typeof(EverythingIveGot), "TheUnderstudy:EverythingIveGot", CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)]
    [InlineData(typeof(BigBreak), "TheUnderstudy:BigBreak", CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)]
