...
public class SwapPhrasingTests
{
    ...
    public void SwapKeyword_TooltipDescribesTheTrade()
    {
        ...
        // The meaning lives here: trade your rightmost swappable debuff for the rightmost swappable buff
        // from each enemy (whole stacks, no amount cap).
        ...
        Assert.Contains("rightmost", desc, StringComparison.OrdinalIgnoreCase);
    }
}
