...
public class TheUnderstudyCardPoolTests
{
    ...
    public void UnderstudyCard_IsPrePlannedOverriddenOnlyByPromptAndTableRead()
    {
        ...
        Assert.Equal(new[] { "Playlist" }, bCardTypes);
    }
    ...
    public void UnderstudyCard_IsPreTunedOverriddenOnlyByExpectedCards()
    {
        ...
        Assert.Equal(new[] { "CleanSlate", "Experience", "OneUp", "Practice", "Recovery", "Repertoire", "ShowerThought", "Showstopper" }, bCardTypes);
    }
    ...
    [Fact]
    public void Playlist_BeforeCombatStart_DoesNotAttachPlannedModifier_WhenBare()
    {
